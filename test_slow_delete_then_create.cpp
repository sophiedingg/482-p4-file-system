...
// add sleep code after traverse_helper in fs_delete in server.cpp

//    if (path.back() == "slow") {
//        // simulate slow disk IO with a sleep!
//        std::cout << "fs_delete sleeping..." << std::endl;
//        boost::this_thread::sleep_for(boost::chrono::seconds(10));
//        std::cout << "fs_delete woke up" << std::endl;
//    }
...
int main(int argc, char *argv[]) {
    ...
    // start create thread
    std::thread create_thread(fs_create, "user1", "/write_dir/file3", 'f');
