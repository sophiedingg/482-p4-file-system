...
int main(int argc, char *argv[]) {
    ...
    status = fs_create("user2", "/dir2/AnandDavidSophie/Supercalifragilisticexpialidocious/Supercalifragilisticexpialidocious/Supercalifragilisticexpialidocious", 'f');
    assert(!status);
}
